...
export default function SidebarFile({
	...
	return (
        ...
        w-full flex items-center h-7 px-1 pl-6 hover:bg-secondary rounded-sm cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring`}
			>
				<Image
					src={imgSrc}
					alt="File Icon"
